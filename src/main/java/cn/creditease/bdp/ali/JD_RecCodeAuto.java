...
public class JD_RecCodeAuto{  
    ...
    public static void init(){
		DLLPATH = IOTool.getRootPath("dll/jd/sunday_x64.dll");
		System.out.println("DLLPATH:"+DLLPATH);
		LIBPATH = IOTool.getRootPath("dll/jd/jd_mall.lib");
	...
	public static void main(String[] args) throws IOException {
		byte[] bs = IOTool.getContent("D:/2.jpg");
		getCode(bs);
	}
